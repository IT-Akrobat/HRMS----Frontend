            ...
            {logsLoading ? (
              ...
              <ul className="divide-y divide-slate-100 overflow-y-auto no-scrollbar flex-1">
                {logs.map((log) => {
                  ...
                  // row at check-in/out time (same value the Audit Logs
                  // page and Today's Attendance card show for this same
                  // event) -> a fresh live geocode, for older rows saved
                  // before that field existed -> matched company office
                  // name (only when genuinely within its radius) -> raw
