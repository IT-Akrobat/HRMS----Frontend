    ...
    <div>
      ...
      <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
        {loading ? (
          ...
          <div className="flex items-center justify-center gap-2 text-red-600 text-sm py-16">
            <AlertTriangle size={16} />
            {error}
          </div>
        ) : filtered.length === 0 ? (
          <div className="flex flex-col items-center justify-center gap-2 text-slate-400 text-sm py-16">
            <FileText size={24} />
            No documents found.
          </div>
        ) : (
